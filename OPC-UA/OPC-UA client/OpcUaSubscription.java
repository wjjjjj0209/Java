...
public class OpcUaSubscription {
	...
	{		
		String variableName = new String("Mcoordinates.X");
		...
		variableName = new String("Mcoordinates.Y");
		id = new NodeId(2, variableName);
		
		dataItem = new MonitoredDataItem(id, Attributes.Value, MonitoringMode.Reporting);
		dataItem.addChangeListener(m_dataChangeListener);
		
		m_subscription.addItem(dataItem);
		
		variableName = new String("Mcoordinates.Z");
		id = new NodeId(2, variableName);
		...
		variableName = new String("Maxle.Speed");
		id = new NodeId(2, variableName);
		...
		variableName = new String("Machine Tool.FedRate");
		id = new NodeId(2, variableName);
